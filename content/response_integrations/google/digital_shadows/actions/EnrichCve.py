...
SCRIPT_NAME = "DigitalShadows - EnrichCve"
    ...
    try:
        ...
        if target_entities:
            for entity in target_entities:
                ...
                try:
                    ...
                    siemplify.result.add_entity_table(
                        entity.identifier, cve_obj.to_csv()
                    )
                    if cve_obj.links:
            ...
            if successful_entities:
                ...
                output_message += "Successfully enriched CVEs:\n {0}\n".format(
                ...
                result_value = "false"
            if failed_entities:
                output_message += "Failed to enrich CVEs:\n {0}".format(
        ...
        result_value = "false"
        output_message = f"Error executing action 'Enrich CVE'. Reason: {e}"
