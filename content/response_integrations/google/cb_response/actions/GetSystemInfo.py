...
SCRIPT_NAME = "CBResponse - Get System Info"
            ...
            for entity in target_entities:
                ...
                try:
                    ...
                    siemplify.result.add_entity_table(
                        entity.identifier, sensor.to_csv()
                    )
                    entity.additional_properties.update(
                        sensor.to_enrichment_data(PREFIX)
                    )
                    entity.is_enriched = True

                    output_message += (
                        f"Enriched the following entity:{entity.identifier} \n"
                    )
                    ...
                    output_message += (
                        f"Unable to get system info of {entity.identifier}: \n{e}\n"
                    )
