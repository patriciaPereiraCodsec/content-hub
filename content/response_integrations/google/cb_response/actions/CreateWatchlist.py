...
SCRIPT_NAME = "CBResponse - Create Watchlist"
...
def main():
    ...
    watchlist_type = extract_action_param(
        siemplify,
        param_name="Watchlist Type",
        is_mandatory=True,
        print_value=True,
        input_type=str,
    )
    ...
    try:
        ...
        siemplify.LOGGER.info("Watchlist successfully created.")
        output_message = "Watchlist created."
