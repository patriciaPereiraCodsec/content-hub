...
SCRIPT_NAME = "Cancel Contain Host"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(
                    f"Canceling containment of host {host._id} ({entity.identifier})"
                )
        ...
        if successful_entities:
            output_message += "Successfully created cancel host contain task for the following entities:\n   {}".format(
