...
# CONNECTORS
INDICATORS_CONNECTOR_NAME = f"{PROVIDER_NAME} - Indicators Connector"
...
# SIEM
ANOMALI_STAXX_TO_SIEM_SEVERITY = {"low": 40, "medium": 60, "high": 80, "very-high": 100}

ENDPOINTS = {"login": "/api/v1/login", "intelligence": "/api/v1/intelligence"}
