...
from ..core.constants import CREATE_MEMDUMP_SCRIPT_NAME, INTEGRATION_NAME
...
ACTION_COMPLETE_OUTPUT_MESSAGES = {ALL_FAILED_MSG: "No memdump files were executed."}
...
def main():
    ...
    try:
        ...
        output_message = (
            f"Failed to execute {CREATE_MEMDUMP_SCRIPT_NAME} action! Error is {e}"
        )
...
def collect_json_result(step_handler, item, command, filename, json_result):
    ...
    result.update({"filepath": filename})
