...
from ..core.consts import INTEGRATION_NAME, MARK_THREAT_AS_FAVORITE
...
def main():
    ...
    try:
        ...
        favorite_status = extract_action_param(
            siemplify,
            param_name="Favorite Status",
            is_mandatory=True,
            print_value=True,
            input_type=str,
        )
        ...
        blueliv_manager.mark_threat_as_favorite(
            module_id=module_id,
