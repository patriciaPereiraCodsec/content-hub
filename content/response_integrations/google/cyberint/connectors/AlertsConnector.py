...
def main(is_test_run):
    ...
    try:
        ...
        if lowest_severity_to_fetch and lowest_severity_to_fetch.lower() not in list(
            SEVERITIES.values()
        ):
            raise Exception(
                f"Invalid value given for Lowest Severity To Fetch parameter. Possible values are: "
        ...
        filtered_alerts = manager.get_alerts(
            ...
            severity_filter=(
                api_severities[ui_severities.index(lowest_severity_to_fetch.lower()) :]
