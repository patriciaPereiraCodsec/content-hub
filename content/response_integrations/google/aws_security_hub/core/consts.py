...
MAPPED_VERIFICATION_STATE = (
    {  # map user specified verification state to aws security hub verification state
        "Unknown": "UNKNOWN",
...
MAPPED_WORKFLOW_STATUS = (
    {  # map user specified workflow status to aws security hub workflow status
        "New": "NEW",
        "Notified": "NOTIFIED",
        "Resolved": "RESOLVED",
