...
from ..core.SolarWindsOrionConstants import PROVIDER_NAME, PING_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        output_message = (
            "Successfully connected to the SolarWinds Orion server with the provided connection "
            "parameters!"
        )
        result = True
        ...
        output_message = (
            f"Failed to connect to the SolarWinds Orion server! Error is {e}"
        )
        result = False
