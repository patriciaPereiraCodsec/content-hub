...
def main():
    ...
    for entity in target_entities:
        try:
            ...
            error_message = f'Error rejoin "{entity.identifier}", Error: {str(err)}'
    ...
    if command_ids_csv:
        output_message = f"{','.join([entity.identifier for entity in rejoined_entities])} rejoined successfully."
