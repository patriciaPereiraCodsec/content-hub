...
from ..core.constants import INTEGRATION_NAME, LAUNCH_COMPLIANCE_REPORT_SCRIPT_NAME
...
def main():
    ...
    report_refs = extract_action_param(
        siemplify, param_name="Scan Reference", print_value=True
    )
    ...
    try:
        ...
        siemplify.LOGGER.error(
            f"General error performing action {LAUNCH_COMPLIANCE_REPORT_SCRIPT_NAME}"
        )
