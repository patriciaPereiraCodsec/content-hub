...
from ..core.constants import INTEGRATION_NAME, LAUNCH_PATCH_REPORT_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        siemplify.LOGGER.error(
            f"General error performing action {LAUNCH_PATCH_REPORT_SCRIPT_NAME}"
        )
        siemplify.LOGGER.exception(e)
        report_id = False
        status = EXECUTION_STATE_FAILED
        output_message = (
            f'Error executing action "{LAUNCH_PATCH_REPORT_SCRIPT_NAME}". Reason: {e}'
        )
