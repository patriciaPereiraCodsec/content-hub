...
def main():
    ...
    incident_id = extract_action_param(
        siemplify, param_name="Incident ID", print_value=True, is_mandatory=True
    )
    work_note_text = extract_action_param(
        siemplify, param_name="Work Note Text", print_value=True, is_mandatory=True
    )
    ...
    try:
        ...
        siemplify.LOGGER.error(
            f"General error performing action {ADD_WORK_NOTE_TO_INCIDENT_SCRIPT_NAME}"
        )
