...
def main():
    ...
    comment = extract_action_param(
        siemplify, param_name="Comment", print_value=True, input_type=str
    )
    ...
    reason = extract_action_param(
        siemplify, param_name="Reason", print_value=True, input_type=str
    )
