...
def unisolate_agents(
    ...
    Args:
        ...
        description (str): Description of unisolating.
        ...
        if endpoint.guid in result_data["result_endpoints"]:
            ...
            try:
                ...
                manager.siemplify.LOGGER.error(
                    f"UnIsolation failed no agent {endpoint.guid}"
                )
...
def generate_output_message_and_result(result_data):
    ...
    if result_data["completed"]:
        ...
        if result_data["failed"]:
            result_value = False
            output_message += (
                "Action wasn't able to unisolate the following endpoints in: "
                "{}: {}\n".format(
                    INTEGRATION_DISPLAY_NAME,
...
def main(is_first_run):
    ...
    try:
        ...
        output_message = (
            f"Error executing action {UNISOLATE_ENDPOINT_SCRIPT_NAME}. Reason: {e}\n"
        )
