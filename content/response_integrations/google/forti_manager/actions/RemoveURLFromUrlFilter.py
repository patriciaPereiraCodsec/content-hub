    ...
    try:
        ...
        for entity in target_entities:
            try:
                ...
                prefixless_identifier = forti_manager.remove_url_prefix(
                    entity.identifier
                )
                forti_manager.delete_block_url_record_from_urlfilter_by_id(
                    adom_name, urlfilter_id, prefixless_identifier
                )
        ...
        if success_entities:
            output_message = f'The following entities were removed form url filter: {", ".join( [entity.identifier for entity in success_entities])}'
        else:
