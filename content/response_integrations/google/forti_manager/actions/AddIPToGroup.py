    ...
    try:
        ...
        for entity in target_entities:
            try:
                ...
                address_object_name = forti_manager.construct_address_object_name(
                    entity.identifier
                )
                if not forti_manager.is_address_object_exist(
                    adom_name, address_object_name
                ):
                    # Create address object.
                    address_object_name = forti_manager.create_address_object(
                        adom_name, entity.identifier
                    )
                # Add address object to an address group.
                forti_manager.add_address_object_to_address_group(
                    adom_name, address_group_name, address_object_name
                )
        ...
        if success_entities:
            output_message = f'The following entities were added to group: {", ".join( [entity.identifier for entity in success_entities])}'
        else:
