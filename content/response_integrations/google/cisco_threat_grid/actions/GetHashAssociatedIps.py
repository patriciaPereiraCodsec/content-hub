...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            if entity.entity_type == EntityTypes.FILEHASH:
                associated_ips = cisco_threat_grid.get_associated_network(
                ...
                if associated_ips:
                    ...
                    siemplify.result.add_entity_table(
                        f"{entity.identifier} - Associated IPs", csv_output
                    )
    ...
    if enriched_entities:
        ...
        output_message = (
            "Cisco Threat Grid - Found associated ips for the following entities\n"
            + "\n".join(entities_names)
        )
