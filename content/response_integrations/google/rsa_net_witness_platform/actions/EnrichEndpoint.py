...
def main():
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            if entity_object:
                ...
                if (
                    ...
                    and entity_object.risk_score > risk_score_threshold
                ):
                ...
                siemplify.LOGGER.info(
                    f"Successfully enriched the following endpoint from RSA NetWitness: {entity.identifier}"
                )
        ...
        if failed_entities:
            output_message += "\n\n Action was not able to enrich the following endpoints from RSA NetWitness: {}".format(
