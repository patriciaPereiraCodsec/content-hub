...
from ..core.constants import INTEGRATION_NAME, UNISOLATE_ENDPOINT_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            if entity_object:
                try:
                    rsa_manager.unisolate_endpoint(
        ...
        if successful_entities:
            output_messages.append(
                "Successfully requested unisolation for the following endpoints from RSA Netwitness:"
                " {}".format(
        ...
        if failed_entities:
            result_value = False
            output_messages.append(
                "Action was not able to request unisolation for the following endpoints from "
        ...
        output_message = f'Error executing action "Unisolate Endpoint". Reason: {e}'
        result_value = False
