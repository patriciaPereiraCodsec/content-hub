...
def main():
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(
                    f"Entity {entity.identifier} was already on the blocklist in "
                    f"{INTEGRATION_NAME}."
                )
        ...
        if successful_entities:
            output_message = "Successfully added the following entities to blocklist in {}: \n{}".format(
                INTEGRATION_NAME,
            ...
            result = False
            output_message = (
                "None of the provided entities were added to the blocklist in "
                f"{INTEGRATION_NAME}."
            )
        ...
        siemplify.LOGGER.error(
            ...
            f"{ADD_ENTITIES_TO_BLOCKLIST_ACTIONS_SCRIPT_NAME}"
        )
        ...
        output_message = (
            ...
            f"{ADD_ENTITIES_TO_BLOCKLIST_ACTIONS_SCRIPT_NAME}. Reason: {e}"
        )
