    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                ip_reputation = manager.get_ip_reputation(
                    entity.identifier
                )  # Reputation Model
                siemplify.LOGGER.info(
                ...
                if (
                    ip_reputation.risk > threshold
                    and ip_reputation.reputation_classification.classification
                ...
                if create_insight:
                    ...
                    siemplify.add_entity_insight(
                        entity,
                        message=ip_reputation.as_insight(),
                        triggered_by=INTEGRATION_NAME,
                    )

                prefixed_file_reputation = add_prefix_to_dict(
                    ip_reputation.enriched_data_to_flatted_dict(),
                    ENTITY_ENRICHMENT_PREFIX,
                )
                ...
                json_results[entity.identifier] = (
                    ip_reputation.raw_response_without_status
                )
