...
from ..core.consts import INTEGRATION_IDENTIFIER, INTEGRATION_DISPLAY_NAME, PING_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        output_message = (
            f"Successfully connected to the {INTEGRATION_DISPLAY_NAME} instance with the provided "
