"""Move Messages To Inbox action for Abnormal Security Google SecOps SOAR Integration."""
...
@output_handler
def main() -> None:
    """Main execution logic for the Move Messages To Inbox action."""
    ...
    try:
        ...
        output_message = (
            f"Move-to-inbox request submitted for {len(messages)} message(s). Activity Log ID: {activity_log_id}."
        )
        result_value = True
